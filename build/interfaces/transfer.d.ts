...
export declare type ITransferStatus = 'finished' | 'aborted' | 'closed';
export declare type ITransferType = 'download' | 'upload';
export declare type IConcurrentTransferStatus = 'pending' | 'transfering' | ITransferStatus;
...
export declare type IConcurrentTransferInfo = Omit<ITransferInfo, 'context' | 'startAt'> & {
